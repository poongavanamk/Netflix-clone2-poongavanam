...
import img1 from './1stimage.jpg'
import img2 from './2ndimage.jpg'
import img3 from './3rdimage.jpg'
import img4 from './4thimage.jpg'
import img5 from './5thimage_files/image7 (1).jpg'
import img6 from './5thimage_files/image7 (5).jpg'
import img7 from './5thimage_files/image7 (6).jpg'
import img8 from './5thimage_files/image7 (7).jpg'
import img9 from './5thimage_files/image7 (3).jpg'
import img10 from './5thimage_files/image7 (4).jpg'

import img11 from './5thimage_files/image7 (8).jpg'
import img12 from './5thimage_files/image7 (9).jpg'
import img13 from './5thimage_files/image7 (10).jpg'
import img14 from './5thimage_files/image7 (11).jpg'
import img15 from './5thimage_files/image7 (12).jpg'
import img16 from './5thimage_files/image7 (13).jpg'
import img17 from './5thimage_files/image7 (14).jpg'
import img18 from './5thimage_files/image7 (15).jpg'
import img19 from './5thimage_files/image7 (16).jpg'
import img20 from './5thimage_files/image7 (17).jpg'
...
const categories = [
  {
    ...
    shows: [
      ...
      { image: img3, title: 'Adolescence',                        video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img4, title: 'Stranger Things',                    video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img5, title: 'Business Proposal' ,                 video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img6, title: 'GyoeongSeong Creature' ,             video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img7, title: 'The Last Kingdom',                   video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img8, title: 'The King Eternal + Monarch' ,        video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img9, title: 'Our Belowed Summer',                 video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
  ...
  },
  {
    ...
    shows: [
      { image: img11, title: 'Queen of Tears',                    video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img12, title: 'Tribhuvan Mishra Cs Topper',        video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img13, title: 'Emily In Paris',                    video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img14, title: 'Brid Geriton',                      video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img15, title: 'My Life With The Walter Boys' ,     video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img16, title: 'Pulse',                             video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img17, title: 'House Of Cards',                    video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img18, title: 'Destined With You',                 video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img19, title: 'Back In Action',                    video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
  ...
  },
  {
    title: 'Made In India',
    shows: [
      { image: img21, title: 'Test',                              video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img22, title: 'Khakee: The Bihar Chapter',         video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img23, title: 'Mismatched' ,                       video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img24, title: 'Black Warrant' ,                    video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img25, title: 'Dhoom Dhaam' ,                      video: 'https://www.w3schools.com/html/mov_bbb.mp4'},
      { image: img26, title: 'The Great Indian Kapil Show',       video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
      { image: img27, title: 'Do Patti',                          video: 'https://www.w3schools.com/html/mov_bbb.mp4' },
